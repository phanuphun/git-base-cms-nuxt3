...
title: Nuxt Content
date: '2024/09/12'
description: เนื้อหาภายในบทความนี้จะเป็นบันทึกการใช้งาน nuxt content ในการทำเว็บบล็อคส่วนตัวของผมเอง
...
Table of content(TOC) เป็นการทำสารบัญจากแท็ก `h1` , `h2` และ `h3` เพื่อง่ายต่อการเลื่อนดูเนื้อหาโดยแยกตามหัวข้อที่แปลง markdown มาเป็น html
